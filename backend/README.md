...
## Project Structure
    ...
    ├── library_isle_storyt_35158  # Django project configurations
...
1. Clone this repo and `cd library_isle_storyt_35158`
...
2. Clone this repo and `cd library_isle_storyt_35158`
